<x-admin-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">Add New Customer</h1>
    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
            <div class="px-6 py-4 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-500 mt-1">Fill in the details below to create a new customer</p>
            </div>

            <form action="{{ route('admin.customer.store') }}" method="POST" class="p-6 space-y-6">
                @csrf
