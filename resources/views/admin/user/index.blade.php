<x-admin-layout>
    ...
    <x-slot name="header">
        ...
        <p class="text-sm text-gray-500">Manage your customers and view their information</p>
    </x-slot>
...
@endif
    ...
    <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
        ...
        <div class="px-6 py-4 border-b border-gray-200 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <h2 class="text-lg font-semibold text-gray-900">All Customers ({{ $customers->total() }})</h2>
            <div class="flex items-center space-x-3">
                <!-- Search Form -->
                <form method="GET" action="{{ route('admin.customer.index') }}" class="flex items-center">
                    <input 
                        type="text" 
                        name="search"
                ...
                <!-- Add Customer Button -->
                <a href="{{ route('admin.customer.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors flex items-center">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($customer->role === 'admin')
                                <span class="px-2.5 py-1 text-xs font-medium text-purple-700 bg-purple-100 rounded-full">Admin</span>
                            @else
                                <span class="px-2.5 py-1 text-xs font-medium text-gray-700 bg-gray-100 rounded-full">Customer</span>
                            @endif
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
