...
<head>
    ...
    <title>Admin Dashboard - VOGUE</title>
...
<body class="bg-gray-50" x-data="{ sidebarOpen: false }">
    ...
    >
        ...
        <nav class="px-4 py-6 space-y-1 overflow-y-auto h-[calc(100vh-4rem)]">
            <!-- Dashboard -->
            <a href="#" class="flex items-center space-x-3 px-3 py-2.5 text-sm font-medium text-white bg-blue-600 rounded-lg">
            ...
            <div x-data="{ open: false }">
                <button @click="open = !open" class="w-full flex items-center justify-between px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                    <div class="flex items-center space-x-3">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div x-show="open" x-collapse class="ml-8 mt-1 space-y-1">
                    <a href="#" class="block px-3 py-2 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg">All Products</a>
                    <a href="#" class="block px-3 py-2 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg">Add Product</a>
                    <a href="#" class="block px-3 py-2 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-lg">Categories</a>
                </div>
            </div>

            <!-- Orders -->
            <a href="#" class="flex items-center space-x-3 px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                </svg>
                <span>Orders</span>
                <span class="ml-auto bg-red-100 text-red-600 text-xs font-semibold px-2 py-0.5 rounded-full">12</span>
            </a>

            <!-- Customers -->
            <a href="{{ route('admin.customer.index') }}" class="flex items-center space-x-3 px-3 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
